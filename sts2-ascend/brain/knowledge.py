...
DEFAULT_POLICY = {
    ...
    "power_starve_bonus_base": 2.0,       # 输出饥饿对力量/成长型能力牌的拾取基础加分（第 255 批复盘）：
                                          # Boss 攻坚死因形态是「即时伤害不够、长战无成长」，战斗端已有
                                          # 能力牌长战加成，拾取端此前仍按平面 5 分定价
    "power_starve_bonus_extra_max": 4.0,  # 成长牌饥饿加分随缺口深度放大的上限（与 burst_starve 同构）
    # --- 连战战损疲劳（第 255 批复盘） ---
