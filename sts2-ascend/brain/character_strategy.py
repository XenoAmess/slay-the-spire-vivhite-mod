...
_CONSERVATION_CARDS = (
    _card("AXIOM_RING", "Axiom Ring", "公理护环", "skill", "common",
          CONSERVATION_GEOMETRY, energy=0, margin=3),
    ...
    _card("SCALE_TRANSFORMATION", "Scale Transformation", "尺度变换", "attack",
          "common", CONSERVATION_GEOMETRY, energy=1, life=4, damage=20,
          hits=1, max_hp=2, lethal=True, exhaust=True,
    ...
    _card("AXIOM_OF_LIFE", "Axiom of Life", "生命公理", "attack", "rare",
          ...
          max_hp=6, lethal=True, exhaust=True,
          effects=("max_hp_growth_on_lethal",)),
    _card("INFINITE_EXTENSION", "Infinite Extension", "无限延拓", "ability",
          "rare", CONSERVATION_GEOMETRY, energy=3, life=12, growth=2,
          effects=("each_max_hp_growth_gains_2_more", "bonus_does_not_recurse")),
...
_RECURSIVE_CARDS = (
    ...
    _card("TERMINATION_CONDITION", "Termination Condition", "终止条件", "attack",
          "common", RECURSIVE_ASTRAL, energy=1, life=4, damage=16, hits=1,
          kill_heal=10, lethal=True),
    ...
    _card("SUCCESSOR_FORMULA", "Successor Formula", "后继式", "attack", "common",
          RECURSIVE_ASTRAL, energy=0, life=2, damage=10, hits=1,
    ...
    _card("ASTRAL_PURSUIT", "Astral Pursuit", "星算追猎", "ability", "uncommon",
          RECURSIVE_ASTRAL, energy=0, life=4, kill_draw=2,
...
_CRIMSON_CARDS = (
    ...
    _card("NEGATIVE_SPACE", "Negative Space", "负空间", "skill", "common",
          CRIMSON_INTEGRAL, energy=0, life=2, margin=2,
    ...
    _card("COLOR_CONSERVATION", "Color Conservation", "色彩守恒", "ability",
          "uncommon", CRIMSON_INTEGRAL, energy=0, life=4,
