...
internal static class Program
{
    private static async Task<int> Main()
    {
        ...
        [
            ...
            new("shared combat scene uses Vivhite eye-lens magic", SharedAssetsAcceptanceTests.SharedCombatSceneUsesVivhiteEyeLensMagic),
            new("Vivhite card trail is isolated from Ironclad", VivhiteCardTrailAcceptanceTests.IsIsolatedFromTheIroncladProfile),
            new("shared skin uses verified native magic audio", SharedAssetsAcceptanceTests.SharedSkinUsesVerifiedNativeMagicAudio),
