...
internal static class Program
{
    private static async Task<int> Main()
    {
        ...
        [
            ...
            new("all 61 registered cards have an effective upgrade", CardUpgradeAcceptanceTests.EveryRegisteredCardHasAnEffectiveUpgrade),
            ...
            new("Color Conservation upgrade reduces Cough and keeps zero Energy", FinalBalanceAcceptanceTests.ColorConservationUpgradeReducesCoughAndKeepsZeroEnergy),
            new("Infinite Canvas upgrade reduces Energy and preserves Drain growth", FinalBalanceAcceptanceTests.InfiniteCanvasUpgradeReducesEnergyAndPreservesDrainGrowth),
