        ...
        foreach (var requiredFragment in new[]
                 {
                     ...
                     "Move-DirectoryWithRetry $liveDirectory $backupDirectory",
                     "Move-DirectoryWithRetry $siblingStagingDirectory $liveDirectory",
                     "$rootFailure -is [IO.IOException]",
                     "$rootFailure -is [UnauthorizedAccessException]",
