...
const RAW_PATH := "D:/workspace/slay-the-spire-vivhite-mod/assets/vivhite-ironclad/generated/evolink-paid/2026-08-31/0114-card-closed-domain-mapping-attempt-02/output.png"
const OUTPUT_DIR := "D:/workspace/slay-the-spire-vivhite-mod/assets/vivhite-ironclad/generated/evolink-paid/2026-08-31/0114-card-closed-domain-mapping-attempt-02/inspection"
...
func _init() -> void:
	...
	var safe_width := int(round(float(crop_width) * 0.76))
	var safe_height := int(round(float(crop_height) * 0.76))
	...
	for threshold in thresholds:
		...
		containment[str(threshold)] = {
			"inside_center_crop": bbox != null and bbox_inside(bbox, crop_bounds),
			"inside_central_76_percent": bbox != null and bbox_inside(bbox, safe_bounds),
		}
	...
	var metrics := {
		...
		"central_76_percent_bounds_xyxy_exclusive": safe_bounds,
