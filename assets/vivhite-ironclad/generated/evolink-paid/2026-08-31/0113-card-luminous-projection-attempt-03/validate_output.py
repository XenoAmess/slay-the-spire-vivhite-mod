...
def main() -> None:
    ...
    # Central 76% safe area of the final 1000x760 card crop.
    safe_left = round(1000 * 0.12)
    safe_top = round(760 * 0.12)
    safe_right = round(1000 * 0.88)
    safe_bottom = round(760 * 0.88)
    ...
    metrics = {
        ...
        "deterministic_card_preview": {
            ...
            "central_76_percent_safe_box": safe_box,
            "contained_in_central_76_percent": {
